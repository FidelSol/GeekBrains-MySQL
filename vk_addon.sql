...
--
-- Table structure for table `mesasges`
--
...
--
-- Dumping data for table `mesasges`
--

LOCK TABLES `mesasges` WRITE;
/*!40000 ALTER TABLE `mesasges` DISABLE KEYS */;
/*!40000 ALTER TABLE `mesasges` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `rooms` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `roomname` varchar(50) DEFAULT NULL COMMENT 'Название комнаты',
...
-- Dump completed on 2021-03-17 23:13:43
